...
urlpatterns = [
    path("dongai/<str:goo>/<str:business>/<int:funds>/<str:dong>", views.dong_ai.as_view()),
    path("marketai/<str:goo>/<str:business>/<int:funds>/<str:market>", views.market_ai.as_view()),
